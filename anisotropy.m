...
while count<500
    ...
    % Checking only the 4 Neighbours available 
    if structure(Point_X,max(Point_Y-1,1))+structure(max(Point_X-1,1),Point_Y)+structure(min(Point_X+1,N),Point_Y)+structure(Point_X,min(Point_Y+1,N))==1
